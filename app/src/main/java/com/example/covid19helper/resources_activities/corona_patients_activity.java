...
public class corona_patients_activity extends AppCompatActivity implements itemAdapter.OnItemHoldListener,itemAdapter.OnItemClickListener {
            ...
            if (snapshot.exists()){
                ...
                for(DataSnapshot snapshot_item: snapshot.getChildren()){
                    if(snapshot_item.getValue().equals(muser.getUid())){
                        Toast.makeText(corona_patients_activity.this,"Your Feedback for this lead is already been recorded",Toast.LENGTH_SHORT).show();
                        flag = true;
                    }
                }
                if(!flag){

                    Intent intent = new Intent(corona_patients_activity.this, feedback.class);
                    intent.putExtra("post_id",post_id);
                    intent.putExtra("user_uid", muser.getUid());
                    intent.putExtra("calling_activity",corona_patients_activity.class.toString());
